				...
				<UCard>
					...
					<div class="flex flex-col gap-4">
						...
						>
							...
							<UFormField label="Project" class="flex-1">
								<UInput
						...
						<div class="w-full flex justify-between items-center gap-2">
							<UFormField label="Invoice Number" class="flex-1">
								<UInput placeholder="Invoice Number" class="w-full" />
							</UFormField>

							<UFormField label="Due Date" class="flex-1">
								<DatePicker class-name="w-full" />
							</UFormField>

							<UFormField label="Issue Date" class="flex-1">
								<DatePicker class-name="w-full" />
							</UFormField>
						</div>
					</div>
					...
					<div class="space-y-4">
							...
							>
								...
								<div class="col-span-2">
									<UInput
										...
										min="1"
										@input="
											updateItem(index, 'quantity', item.quantity)
										"
									/>
								</div>
								<div class="col-span-2">
						...
						<div class="flex justify-end space-x-4 border-t pt-4">
							<div class="text-right">
								...
								<div class="text-sm text-muted-foreground">Tax (0%)</div>
